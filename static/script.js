...
async function updateAssetId() {
    ...
    if (company && assetType) {
        ...
        // Only update if the field is empty or contains the placeholder
        const currentValue = document.getElementById('assetId').value;
        if (!currentValue || currentValue === '') {
            document.getElementById('assetId').value = autoGeneratedAssetId;
        }
    }
}
